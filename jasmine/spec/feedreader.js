...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
        ...
        /* Writes a test that loops through each feed
         * in the allFeeds object and ensures it has a URL defined
         * and that the URL is not empty.
         */
         it('has a URL defined and that it is empty', function() {
    ...
    describe('The menu', function() {
        const body = $('body');
        /* Writes a test that ensures the menu element is
    ...
    describe('New Feed Selection', function() {
        ...
        beforeEach(function(done) {
            loadFeed(0, function() {
                oldFeed = $('.feed').html(); // stores old feed
            });
            loadFeed(1, done); // starts new feed
        });
